...
<div class="container"  style="min-height:500px;">
    ...
    <footer id="footer" class="midnight-blue" style="background-color: #47c9af;border-top: 1px solid #47c9ad">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <a target="_blank" href="<?php echo web_root; ?>" title="Free Twitter Bootstrap WordPress Themes and HTML templates">AICS BATANGAS: Computer Laboratory Attendance Monitoring and Profiling System</a>.
                </div> 
